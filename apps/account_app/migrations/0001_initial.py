    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.PositiveBigIntegerField(unique=True, verbose_name='شماره موبایل')),
                ('one_time_password', models.SmallIntegerField(blank=True, null=True, verbose_name='رمز یک بار مصرف')),
